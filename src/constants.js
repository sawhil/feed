export const POSTS = {
       ...
       124: {
        ...
        child: {
          121121: {
            ...
            timestamp: new Date('2022-10-14T00:00:00'),
            child: {},
          },
          121131: {
            id: 121131,
            content: "I'm not sure about the pricing, but I'll consider it.",
            timestamp: new Date('2022-10-15T00:00:00'),
            child: {},
          },
        },
      },
  ...
  2: {
    ...
    timestamp: new Date('2022-10-16T00:00:00'),
    allComments: {
      125: {
        id: 125,
        content: "This is amazing! I'm entering right away.",
        timestamp: new Date('2022-10-17T00:00:00'),
        child: {
          12114: {
            id: 12114,
            content: "Good luck to everyone entering!",
            timestamp: new Date('2022-10-18T00:00:00'),
            child: {},
          },
          12115: {
            id: 12115,
            content: "I've always wanted to visit Hawaii!",
            timestamp: new Date('2022-10-19T00:00:00'),
            child: {},
          },
        },
      },
